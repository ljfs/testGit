...
<title>My JSP 'subjectparentadd.jsp' starting page</title>
...
<body>
	<div align="center">
		<div id="div_subjectparentadd" class="easyui-panel" title="系别添加面板"
			style="width: 500px; height: auto; padding: 10px; background: #fafafa;"
			data-options="closable:true">
			<form id="frm_reputationandident" method="post">
				<table align="center">
					<tr>
						<div align="center">
							<td><label for="name">系别名称:</label></td>
							<td><input id="add_subjectparentname"
